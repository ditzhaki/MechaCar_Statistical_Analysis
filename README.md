...
AutosRUs’ newest prototype, the MechaCar, is suffering from production troubles that are blocking the manufacturing team’s progress. AutosRUs’ upper management has requested help in reviewing the production data for insights that may help the manufacturing team. To help AutosRUs, the following analysis has been conducted using R:
